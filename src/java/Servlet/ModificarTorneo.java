...
public class ModificarTorneo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /* out.print("nombre="+nombre);
         ...
         boolean e = tr.ModificarTorneo(nombre, empleado,  lugar, fechaI,  fechaF, id);
         out.print("registro= "+tr.getError());*/
         
         if(tr.ModificarTorneo(nombre, 
                               empleado,
                               lugar,
                               fechaI,
                               fechaF,
             ...
             RequestDispatcher rd = request.getRequestDispatcher("Torneos"); 
