...
<html>
    ...
    <body>
       ...
       <%ArrayList<Alumno> std = (ArrayList<Alumno>)request.getAttribute("data"); 
        ...
        <hr />
        <form method='post' id='emp-AddForm' action='MAlumno'> 
    <table class='table table-bordered'>
         <tr>
            <td>DNI</td>
            <td><input type='hidden' id='id' name='id' class='form-control'  value="<%=s.getIdAlumno()%>">
                <input type='text' id='dni' name='dni' class='form-control'  value="<%=s.getDni()%>"></td>
        </tr>
        <tr>
            <td>Nombre</td>
