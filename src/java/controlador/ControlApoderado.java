 ...
 * @author MARCOS
 */
public class ControlApoderado extends conexion{
        String err="";
    
public ArrayList<Apoderado> getAllEmpleado() {
         PreparedStatement pst = null;
         ResultSet rs = null;
         int rsCount=0;
          ArrayList<Apoderado> apoderado = new ArrayList<Apoderado>();
         
       try{
           String consulta="SELECT * FROM dbo.Apoderado";
           pst= getConexion().prepareStatement(consulta);
           rs= pst.executeQuery();
            while (rs.next()) {
                Apoderado ap = new Apoderado(rs.getInt("Id_Apoderado"),
                                           rs.getString("NombreApoderado"), 
                                           rs.getString("ApellidoApoderado"),
                                           rs.getString("DetalleApoderado"), 
...
public ArrayList<Apoderado> getEmpleado(int id) {
         PreparedStatement pst = null;
         ResultSet rs = null;
         int rsCount=0;
          ArrayList<Apoderado> apoderado = new ArrayList<Apoderado>();
